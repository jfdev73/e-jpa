INSERT INTO customers (birthday, firt_name, last_name, reg_date, status) VALUES (now(), 'Oscar', 'Blancarte', now(), 'ACTIVE');
INSERT INTO customers (birthday,firt_name,last_name, reg_date, status) VALUES (now(), 'Juan', 'Pérez', now(), 'ACTIVE');
